...
오픈소스 AI Video 생성 모델 Hunyuan의 사실성과 디테일을 높여주는 LoRA 들이 나오고 있네요. Hunyuan은 계속 발전하고 있는 것 같고 오픈소스 모델이 상용 모델을 얼마나 따라잡을 지 주목되네요.
Boreal-HL Hunyuan LoRA
이 LoRA는 훈위안에서 전반적인 디테일을 개선하기 위한 시도입니다. 특히 향상된 피사계 심도, 사실적인 피부 질감, 더 나은 조명과 같은 요소에 중점을 둡니다. 사실적인 짧은 동영상 클립과 이미지의 단일 프레임을 모두 생성하는 데 효과적입니다. 현재 여기에 사용된 후보 LoRA는 과도하게 훈련된 상태입니다. 약 0.6의 강도를 사용하는 것이 좋습니다. 또한 시드, 안내, 스텝, 해상도를 다양하게 실험해 보아야 합니다. 단계는 35 이상, 최소 해상도는 512x512 이상으로 유지하세요. 안내는 3.5-12.5 사이에서 다양한 정도로 작동하는 것 같습니다. 안내와 강도가 높을수록 장면과 캐릭터 등의 유사성이 높아질 수 있습니다. 왜곡이 많이 발생하면 안내와 강도를 낮추고 해상도를 높이는 실험을 해보는 것이 좋습니다.
LoRA : kudzueye/boreal-hl-v1
